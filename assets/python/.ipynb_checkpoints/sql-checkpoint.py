...
_HOST = '10.121.220.126'
_UID = 'postgres'
_PWD = r'bBVJ6zeMbJ7y7j2k'
_PORT = 5432
_DB = 'portal'
...
class PGSQL:
    ...
    def sql_to_df(self, query, params=None, db='portal', mod=None) -> Union[pd.Series, pd.DataFrame]:
    ...
    def execute_concurrent_queries(self, query1, param1, query2, param2, query3, param3,
                                   db='portal') -> tuple[pd.DataFrame, pd.DataFrame, pd.DataFrame]:
        class_method = class_method_name()
        try:
